 ...
 * Kompilacja:          clang -o cipher_cbc cipher_cbc.c -lcrypto 
 * Uruchamianie:        ./cipher_cbc <padding>
 */
...
int main(int argc, char **argv) 
{
    ...
    /* Szyfrowanie: */
    retval = EVP_EncryptUpdate(ctx, ciphertext, &ciphertext_len, (unsigned char*)plaintext, plaintext_len);
